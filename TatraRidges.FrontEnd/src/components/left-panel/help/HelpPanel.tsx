            ...
            <PanelHeader text="Instukcja"/>
				<section className={classes["info"]}>
					...
					<p>
						...
						szczytami/przełęczami należy zaznaczyć prawym przyciskiem myszy
						punkty jeden po drugim.
					</p>
					<img
					...
					<p>
						...
						się ikonka z ilością dostępnych pozostałych wariantów.
					</p>
					<img
                    ...
                    <p>Żeby zmienić kolejność punktów należy kliknąć przycisk ze strzałkami.</p>
                    <img
